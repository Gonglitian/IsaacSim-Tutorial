...
class Template:
    ...
    def setup_scene(self):
        ...
        self.robot_controller = WheelBasePoseController(name="cool_controller",
    ...
    def physics_callback(self, dt: float):
        ...
        """
        position, orientation = self.jetbot_robot.get_world_pose()
        self.jetbot_robot.apply_action(
            self.robot_controller.forward(start_position=position,
